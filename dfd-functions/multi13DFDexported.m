function [featureTable,outputTable] = multi13DFDexported(inputData)
...
%  accX_sigstats_1/CrestFactor
%  accX_sigstats_1/Kurtosis
%  accX_sigstats_1/Mean
%  accX_sigstats_1/PeakValue
%  accX_sigstats_1/RMS
%  accX_sigstats_1/Skewness
%  accX_sigstats_1/Std
%  accX_sigstats_2/CrestFactor
%  accX_sigstats_2/Kurtosis
%  accX_sigstats_2/Mean
%  accX_sigstats_2/PeakValue
%  accX_sigstats_2/RMS
%  accX_sigstats_2/Skewness
%  accX_sigstats_2/Std
%  accX_sigstats_3/CrestFactor
%  accX_sigstats_3/Kurtosis
%  accX_sigstats_3/Mean
%  accX_sigstats_3/PeakValue
%  accX_sigstats_3/RMS
%  accX_sigstats_3/Skewness
%  accX_sigstats_3/Std
%  accX_sigstats_4/CrestFactor
%  accX_sigstats_4/Kurtosis
%  accX_sigstats_4/Mean
%  accX_sigstats_4/PeakValue
%  accX_sigstats_4/RMS
%  accX_sigstats_4/Skewness
%  accX_sigstats_4/Std
...
% Auto-generated by MATLAB on 20-Feb-2025 10:15:08
...
while hasdata(outputEnsemble)
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            % Store computed features in a table.
            featureNames = {'CrestFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','Std'};
            accX_sigstats_1 = array2table(featureValues,'VariableNames',featureNames);
        catch
            % Store computed features in a table.
            featureValues = NaN(1,7);
            featureNames = {'CrestFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','Std'};
        ...
        % Append computed results to the frame table.
        frame = [frame, ...
            table({accX_sigstats_1},'VariableNames',{'accX_sigstats_1'})];
        ...
        try
            ...
            % Store computed features in a table.
            featureNames = {'CrestFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','Std'};
            accX_sigstats_2 = array2table(featureValues,'VariableNames',featureNames);
        catch
            % Store computed features in a table.
            featureValues = NaN(1,7);
            featureNames = {'CrestFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','Std'};
        ...
        % Append computed results to the frame table.
        frame = [frame, ...
            table({accX_sigstats_2},'VariableNames',{'accX_sigstats_2'})];
        ...
        try
            ...
            % Store computed features in a table.
            featureNames = {'CrestFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','Std'};
            accX_sigstats_3 = array2table(featureValues,'VariableNames',featureNames);
        catch
            % Store computed features in a table.
            featureValues = NaN(1,7);
            featureNames = {'CrestFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','Std'};
        ...
        % Append computed results to the frame table.
        frame = [frame, ...
            table({accX_sigstats_3},'VariableNames',{'accX_sigstats_3'})];
        ...
        try
            ...
            % Store computed features in a table.
            featureNames = {'CrestFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','Std'};
            accX_sigstats_4 = array2table(featureValues,'VariableNames',featureNames);
        catch
            % Store computed features in a table.
            featureValues = NaN(1,7);
            featureNames = {'CrestFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','Std'};
        ...
        % Append computed results to the frame table.
        frame = [frame, ...
            table({accX_sigstats_4},'VariableNames',{'accX_sigstats_4'})];
